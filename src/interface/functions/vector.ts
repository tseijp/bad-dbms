 ...
 * ```
 */
export const l2Distance = (column: SQL | Column, value: number[] | string[] | string) => {}
 ...
 * ```
 */
export const l1Distance = (column: SQL | Column, value: number[] | string[] | string) => {}
 ...
 * ```
 */
export const innerProduct = (column: SQL | Column, value: number[] | string[] | string) => {}
 ...
 * ```
 */
export const cosineDistance = (column: SQL | Column, value: number[] | string[] | string) => {}
 ...
 * ```
 */
export const hammingDistance = (column: SQL | Column, value: number[] | string[] | string) => {}
 ...
 * ```
 */
export const jaccardDistance = (column: SQL | Column, value: number[] | string[] | string) => {}
