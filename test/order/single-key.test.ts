...
describe('single-key ordering across row counts and shapes', () => {
        ...
        it.each([
                ...
                ['two rows arriving high then low', [{ id: 1, score: 9 }, { id: 2, score: 2 }], [2, 9]],
                ['three rows fully scrambled', [{ id: 1, score: 20 }, { id: 2, score: 5 }, { id: 3, score: 12 }], [5, 12, 20]],
                ['four rows in reverse', [{ id: 1, score: 40 }, { id: 2, score: 30 }, { id: 3, score: 20 }, { id: 4, score: 10 }], [10, 20, 30, 40]],
                ['six rows scrambled', [{ id: 1, score: 60 }, { id: 2, score: 10 }, { id: 3, score: 50 }, { id: 4, score: 20 }, { id: 5, score: 40 }, { id: 6, score: 30 }], [10, 20, 30, 40, 50, 60]],
        ...
        it.each([
                ['one row', [{ id: 1, score: 7 }], [7]],
                ['two rows arriving low then high', [{ id: 1, score: 2 }, { id: 2, score: 9 }], [9, 2]],
                ['three rows fully scrambled', [{ id: 1, score: 20 }, { id: 2, score: 5 }, { id: 3, score: 12 }], [20, 12, 5]],
                ['five rows scrambled', [{ id: 1, score: 30 }, { id: 2, score: 50 }, { id: 3, score: 10 }, { id: 4, score: 40 }, { id: 5, score: 20 }], [50, 40, 30, 20, 10]],
        ...
        it.each([[1], [2], [3], [8], [16], [32]])(
                'an ascending sort of %i rows inserted in descending order recovers ascending ids',
                async (n) => {
                        const { db, t } = fresh(makeScored)
