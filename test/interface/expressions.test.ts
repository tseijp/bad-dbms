...
import { eq, ne, lt, lte, gt, gte, and, or, not, between, inArray, isNull, isNotNull } from '../../src/interface/expressions/conditions'
...
describe('range and list predicates', () => {
        ...
        it('inArray emits binop in with values list wrapped element-wise', () => {
                ...
                expect(e.node.args[1].node).toMatchObject({
                        type: 'list',
