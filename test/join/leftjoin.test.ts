...
describe('leftJoin keeps every left row', () => {
        ...
        it.each([
                ['all matched', [[1, 10], [2, 20]] as Array<[number, number]>, [[1, 1, 100], [2, 2, 200]] as Array<[number, number, number]>, 2],
                ['one orphan left', [[1, 10], [2, 20]] as Array<[number, number]>, [[1, 1, 100]] as Array<[number, number, number]>, 2],
                ['all orphan left', [[1, 10], [2, 20]] as Array<[number, number]>, [] as Array<[number, number, number]>, 2],
                ['one-to-many keeps count', [[1, 10], [2, 20]] as Array<[number, number]>, [[1, 1, 100], [2, 1, 200]] as Array<[number, number, number]>, 3],
        ...
        it.each([
                ...
                ['one left gets two', [[1, 1, 1], [2, 1, 2]] as Array<[number, number, number]>, 4],
                ['one left gets three', [[1, 1, 1], [2, 1, 2], [3, 1, 3]] as Array<[number, number, number]>, 5],
                ['matches plus a miss', [[1, 1, 1], [2, 9, 2]] as Array<[number, number, number]>, 4],
                ['all miss', [[1, 7, 1], [2, 8, 2]] as Array<[number, number, number]>, 3],
                ['heavy fan-out on one', [[1, 2, 1], [2, 2, 2], [3, 2, 3]] as Array<[number, number, number]>, 5],
        ...
        it.each([
                ...
                ['full matches', [[1, 1, 1], [2, 2, 2], [3, 3, 3]] as Array<[number, number, number]>],
