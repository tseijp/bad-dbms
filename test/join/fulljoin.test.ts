...
describe('fullJoin keeps unmatched rows from both sides', () => {
        ...
        it.each([
                ...
                ['both matched', [[1, 1, 1], [2, 2, 2]] as Array<[number, number, number]>, 2],
                ['one matched one left orphan', [[1, 1, 1]] as Array<[number, number, number]>, 2],
                ['one matched one right orphan', [[1, 1, 1], [2, 9, 2]] as Array<[number, number, number]>, 3],
                ['all orphan both sides', [[1, 8, 1], [2, 9, 2]] as Array<[number, number, number]>, 4],
                ['fan-out plus right orphan', [[1, 1, 1], [2, 1, 2], [3, 9, 3]] as Array<[number, number, number]>, 4],
