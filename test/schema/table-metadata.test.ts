...
describe('table node and declared shape', () => {
        ...
        it('builds a twelve-column table reporting length 12', () => {
                const t = table('big', {
                        c0: integer('c0'), c1: integer('c1'), c2: integer('c2'),
                        c3: integer('c3'), c4: integer('c4'), c5: integer('c5'),
                        c6: integer('c6'), c7: integer('c7'), c8: integer('c8'),
                        c9: integer('c9'), c10: integer('c10'), c11: integer('c11'),
                })
